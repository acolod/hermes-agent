...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_agents_command(self, event: MessageEvent) -> str:
        ...
        command_name = getattr(event, "get_command", lambda: "")()
        command_args = getattr(event, "get_command_args", lambda: "")()
        if (
            str(command_name or "").strip().lower() == "tasks"
            or str(command_args or "").strip().lower() == "tasks"
        ):
