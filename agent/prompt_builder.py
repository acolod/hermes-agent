...
KANBAN_GUIDANCE = (
    ...
    "(default 4 hours) only when no heartbeat has arrived in the last hour. "
    "Those reclaims re-queue the task as `ready` without penalty (no failure counter "
    ...
    "- **Attachments.** Attach downloadable artifacts, not comment links: "
    "`kanban_attach` (base64) or `kanban_attach_url` "
